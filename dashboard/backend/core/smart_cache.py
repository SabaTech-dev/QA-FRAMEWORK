...
class SmartCache:
    ...
    def __init__(self, redis_host: str = "localhost", redis_port: int = 6379, db: int = 0):
        ...
        self.stats = {"hits": 0, "misses": 0, "invalidations": 0, "sets": 0}

    def _generate_key(self, prefix: str, identifier: str) -> str:
        """Generate cache key from prefix and identifier."""
        # blake2b 128-bit: md5 truncated to 64 bits allows cross-tenant collisions in multi-tenant Redis
        key_hash = hashlib.blake2b(identifier.encode(), digest_size=16).hexdigest()
